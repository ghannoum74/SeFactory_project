...
class FriendshipCommunity:
    ...
    # def dfscheckingBestFriend(self,current_user_email ,visited = None, result = None):
    ...
    #     if current_user_email in self.adj_list:
    #         temp_current = self.adj_list[current_user_email].head
    #         while temp_current :
    #             temp_destination = self.adj_list[temp_current.email].head

    #             while temp_destination:
    #                 if temp_destination.email == current_user_email and temp_current.email in self.adj_list[temp_destination.email]:
    #                     print("True")
    #                 else :
    #                     print("false")
